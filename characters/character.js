...
let gandalfequip=new Equip(),gandalfinv=new Inventory(),gandalfspell=new SpellList(['firebolt']);
...
require('node:fs').writeFileSync('test.json',JSON.stringify(personagem))